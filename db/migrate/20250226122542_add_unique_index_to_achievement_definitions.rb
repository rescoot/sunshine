class AddUniqueIndexToAchievementDefinitions < ActiveRecord::Migration[8.0]
  def up
    # First, clean up duplicate achievements
    puts "Starting achievement cleanup before adding unique index..."
    ...
    add_index :achievement_definitions, :name, unique: true
    puts "Added unique index on achievement_definitions.name"
  end

  def down
    remove_index :achievement_definitions, :name
  end
end
